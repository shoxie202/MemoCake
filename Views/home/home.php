                ...
                <div class="section-title text-center">
                    <div class="product-tab nav nav-tabs">
                        <ul>
                            ...
                            <li><a data-toggle="tab" href="#best">Phụ kiện sinh nhật</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<section class="collection-area collection-area2 section-padding">
    ...
    <div class="row">
        ...
        <div class="row" >
            ...
            <div class="col-sm-4">
                <div class="collect-img banner margin single-colect">
                    <a href="#"><img src="public/<?= $data_random['2']['HinhAnh2'] ?>" alt="" /></a>
                </div>
                <div class="colect-text ">
                    <h4><a href="#"><?= $data_random['2']['TenSP'] ?></a></h4>
                    <h5>Giá: <?= number_format($data_random['2']['DonGia']) ?> VNĐ</h5>
                    <a href="?act=detail&id=<?= $data_random['2']['MaSP'] ?>">Mua ngay <i class="mdi mdi-arrow-right"></i></a>
                </div>
            </div>
        </div>
    </div>
